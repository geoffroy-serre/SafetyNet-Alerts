...
public class ExceptionResponseTest {
  ...
  public void testSetTimestamp() {
    ExceptionResponse exceptionResponse = new ExceptionResponse(new Date(1L), 1, "An error occurred",
            "An error occurred", "Path");
    exceptionResponse.setTimestamp(new Date(1L));
    assertEquals(
            "ExceptionResponse{timestamp=Thu Jan 01 01:00:00 CET 1970, status=1, error='An error occurred', message='An"
